...
Über den Befehl `/pholo removeplot` werden [alle Hologramme auf dem Grundstück](../befehlsuebersicht/spezielle-features/hologramme.md) gelöscht. Das heißt, dass die eigenen Hologramme eigenständig neu gesetzt werden müssen.
