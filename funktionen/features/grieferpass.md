...
Diese Leiste füllt sich von rot zu grün, bis das nächste Level erreicht wurde. Ganz rechts auf dem Erfahrungsfläschchen findest du Informationen über dein aktuelles Level, deine aktuellen XP und wie viel XP du noch benötigst, um das nächste Level zu erreichen.
...
Diese bringen die meisten XP. Hinter jedem Buch finden sich eine Reihe unterschiedlicher Aufgaben. Diese werden zufallsbasiert generiert und es werden jede Woche neue Aufgaben freigeschaltet, die ab Freischaltung der Woche absolviert werden können.

Hier ein paar Beispiele, wie diese Aufgaben aussehen könnten:
...
Ist eine Woche komplett abgeschlossen, wird diese Woche als verzaubertes Buch ![](<../../.gitbook/assets/unknown (9).png>) dargestellt und somit als „erledigt“ markiert.
...
* Wie viel XP gibt dir diese Aufgabe?
...
Unterhalb der Weekly Aufgaben finden sich Daily Aufgaben, also täglich neue Aufgaben.

Hier wird noch einmal unterschieden in **täglich immer vorhandene** und **täglich rotierende Aufgaben**.

#### Täglich immer vorhandene Aufgaben
...
Tötest du nun Lohen, werden diese zuerst bei der Daily Aufgabe angerechnet, anschließend bei Woche 1 und erst zum Schluss bei Woche 7.
...
Da ein Stack in Minecraft nicht mehr als 64 Items umfassen kann, sind höhere Level ebenfalls mit „64“ markiert. Geht man mit der Maus über die XP-Flasche, kann man das entsprechende Level jedoch in der Itembeschreibung ablesen.
...
{% hint style="warning" %}
Alle erspielten Belohnungen müssen bis zum [Ende der Season](grieferpass.md#aktuelle-season) abgeholt worden sein.
