...
{% hint style="info" %}
Jeder Spieler kann einen Clan für 5.000.000$ erstellen. Bei der Auflösung eines Clans werden 2.000.000$ (40 % der Kosten) an den Clan-Leiter zurückerstattet.
{% endhint %}
...
| `/clan setname <Clan-Name>` | Damit setzt man den Clan-Namen, welcher nicht länger als 16 Zeichen sein darf. |  |
