...
Du willst frei durch die Lüfte schweben oder einfach mehr Erfahrung sammeln?\
Hierfür gibt es Booster auf GrieferGames, die auf verschiedene Wege gezündet werden können.

Folgende Booster gibt es auf GrieferGames:

<table><thead><tr><th width="179">Booster-Name</th><th width="360">Effekt:</th><th>Chatbefehl</th></tr></thead><tbody><tr><td>Fliegen-Booster</td><td>Spieler können in der Plotwelt fliegen</td><td>/booster fly</td></tr><tr><td>Mob-Booster</td><td>Erhöht die Anzahl Monster-Drops</td><td>/booster mob</td></tr><tr><td>Drop-Booster</td><td>Erhöht die Anzahl an Items beim Abbauen</td><td>/booster drop</td></tr><tr><td>XP-Booster</td><td>Erhöht die erhaltenen Erfahrungspunkte</td><td>/booster xp</td></tr><tr><td>Break-Booster</td><td>Ermöglicht schnelleres Abbauen / hoher Eile-Effekt</td><td>/booster break</td></tr><tr><td>All-Booster</td><td>Kann genutzt werden, um einen beliebigen anderen Booster zu aktivieren.</td><td></td></tr><tr><td><a href="https://items.griefergames.net/#Rechte_%7C_1_Bonze-Booster">Bonze-Booster</a></td><td>Aktiviert alle Booster auf der maximalen Stufe (Stufe 5)</td><td>/booster bonze</td></tr></tbody></table>
...
Du hast die Möglichkeit Booster am [Case-Opening](das-case-opening.md) am Spawn zu gewinnen.\
Die Booster findest du in unterschiedlichen Kisten.

Solltest du nicht auf dein Glück vertrauen, kannst du Booster auch einfach direkt im GrieferGames [Webshop](/broken/pages/Ih0m8YSsNDzPV0hOc7Vv) kaufen.

Booster kannst du ebenfalls [rangabhängig](../befehlsuebersicht/rang-befehle.md#griefer) bekommen.\
Ab dem Griefer-Rang erhältst du alle 14 Tage einen zufälligen Booster geschenkt. Gib einfach `/grieferboost` im Chat ein, um deinen kostenlosen Booster zu erhalten.
...
Perks kannst du für [GrieferGames-Dollar](../waehrungen.md#griefergames-dollar) kaufen oder beim [Orb-Verkäufer](das-orb-system.md#perks) mit deinen Orbs erwerben oder im CaseOpening aus verschiedenen Kisten gewinnen.\
...
| [Flugtrank](https://items.griefergames.net/#Orb-Items_%7C_Flugtrank_)            | Erlaubt es dir für 15 Minuten zu fliegen                                 | 350.000 Orbs |
| -------------------------------------------------------------------------------- | ------------------------------------------------------------------------ | ------------ |
...
Zusätzlich gibt es noch ein Item, welches dir erlaubt auf deinem Grundstück das Fliegen zu ermöglichen. Hierzu werden dann weder Booster noch Tränke benötigt. Dieses Item erhältst du gelegentlich beim [Adventurer](das-adventurer-system.md#der-admin-shop) oder als Gewinn aus dem [Case-Opening](das-case-opening.md).
