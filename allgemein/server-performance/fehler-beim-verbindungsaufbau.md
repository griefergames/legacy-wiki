...
* Verbindest du dich auf **GrieferGames** über <kbd>griefergames.net</kbd>?
  ...
  * Für das Verbinden auf unsere Server empfehlen wir die Adresse "griefergames.net".
    ...
    * Die Alternativadresse <kbd>cloud.griefergames.net</kbd> kann direkt auf unser [Cloud-Netzwerk](https://app.gitbook.com/o/nS9KOXaVZVX5hWgLD6av/s/i10PgHQTIUUm2awhkL0L/) verbinden. Du benötigst hierfür **mindestens** den [Premium-Rang](../../funktionen/befehlsuebersicht/rang-befehle.md#premium).
